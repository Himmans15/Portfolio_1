...
const Header = () => {
  ...
  return (
    <header className="flex items-center p-5 bg-gray-800 text-white relative">
      ...
      <nav className={`flex text-2xl space-x-6 flex-grow justify-center md:flex ${menuOpen ? 'hidden' : 'hidden'}`}>
        <a href="#about" className="hover:text-green-500 hover:bg-gray-700 px-3 py-2 rounded-md transition-all">About</a>
        <a href="#skills" className="hover:text-orange-500 hover:bg-gray-700 px-3 py-2 rounded-md transition-all">Skills</a>
        <a href="#projects" className="hover:text-pink-500 hover:bg-gray-700 px-3 py-2 rounded-md transition-all">Projects</a>
        <a href="#contact" className="hover:text-sky-500 hover:bg-gray-700 px-3 py-2 rounded-md transition-all">Contact</a>
      </nav>
      ...
      >
        ...
        <a href="#skills" className="text-xl hover:border-b-2 hover:border-orange-300 px-2 py-1 rounded-md transition-all">Skills</a>
        <a href="#projects" className="text-xl hover:border-b-2 hover:border-orange-300 px-2 py-1 rounded-md transition-all">Projects</a>
        <a href="#contact" className="text-xl hover:border-b-2 hover:border-orange-300 px-2 py-1 rounded-md transition-all">Contact</a>
      </div>
    </header>
  );
};
